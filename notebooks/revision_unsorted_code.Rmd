...
lapply(sra,function(x){
  grosselin.frip <- read.table(file=paste0(params$out_prefix,'other_datasets/grosselin_scChIP/',x,'/frip/',x,'_cell_statistics.txt'),stringsAsFactors=FALSE)
})
```
