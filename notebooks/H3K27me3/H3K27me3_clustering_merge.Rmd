...
brain.merged <- brain.merged[,brain.merged$promoter_ratio < 0.6]
...
markers <- FindAllMarkers(brain.merged,min.pct = 0.02,logfc.threshold = 0.5,slot = 'data')
...
samples <- samples[samples == antibody]
