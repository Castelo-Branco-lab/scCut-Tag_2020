...
e(paste0(params$out_prefix,params$antibody,"/clustering/bigwig_inspect/clusters_all/"),recursive = TRUE)
e(paste0(params$out_prefix,params$antibody,"/clustering/markers_bed/"),recursive = TRUE)
e(paste0(params$out_prefix,params$antibody,'/clustering/bam_per_cluster/'))
```
...
```{r export_bw}
e(paste0(params$out_prefix,params$antibody,"/clustering/bigwig/clusters_all/"),recursive = TRUE)
