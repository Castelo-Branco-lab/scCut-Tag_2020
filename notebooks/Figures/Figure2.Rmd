...
png(file = paste0(params$out_prefix,'/Figures/figure2_src/H3K4me3_UMAP_markers.png'),width = 2700,height=500)
...
ggsave(filename =  paste0(params$out_prefix,'/Figures/figure2_src/H3K4me3_amounts.png'),width=6,height=3)
```
...
png(file = paste0(params$out_prefix,'/Figures/figure2_src/H3K27me3_UMAP_markers.png'),width = 2700,height=500)
do.call(grid.arrange,c(p,nrow=1))
dev.off()
...
ggsave(filename = paste0(params$out_prefix,'/Figures/figure2_src/H3K27me3_amounts.png'),width=6,height=4)
...
png(file = paste0(params$out_prefix,'/Figures/figure2_src/H3K27ac_UMAP_markers.png'),width = 1500,height=500)
do.call(grid.arrange,c(p,nrow=1))
dev.off()
...
ggsave(filename = paste0(params$out_prefix,'/Figures/figure2_src/H3K27ac_amounts.pdf'),width=6,height=3)
```
...
png(file = paste0(params$out_prefix,'/Figures/figure2_src/H3K36me3_UMAP_markers.png'),width = 1200,height=500)
do.call(grid.arrange,c(p,nrow=1))
dev.off()
...
ggplot(data=brain.H3K36me3[,brain.H3K36me3@active.ident != 'Unknown']@meta.data, aes(x=logUMI,y=cell_type,fill=cell_type))  + 
  geom_density_ridges() + 
  scale_fill_manual(values = CTcolors) + 
  coord_cartesian(xlim=c(1.0,2.8),ylim=c(1,6)) + theme_bw()+ NoLegend() + 
  theme(text = element_text(size=24,face = 'bold')) + ylab("") + xlab("unique reads [log10]") + ggtitle("H3K36me3")

ggsave(filename = paste0(params$out_prefix,'/Figures/figure2_src/H3K36me3_amounts.pdf'),width=6,height=3)
