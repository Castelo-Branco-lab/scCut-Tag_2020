...
```{r}
if (dir.exists("../Figure2_src")) {unlink("../Figure2_src",recursive = TRUE)}
dir.create("../Figure2_src")  
```
...
brain.H3K4me3           <- readRDS("~/snakemake/figures_paper/H3K4me3/clustering_1/01.clustering_PA_GA.Rds")

brain.H3K4me3$cell_type <- brain.H3K4me3@active.ident
brain.H3K4me3$cell_type <- factor(brain.H3K4me3$cell_type,levels=c("Astrocytes","mOL","OEC","VLMC","OPC"))
...
```{r}
brain.H3K4me3 <- readRDS("~/snakemake/figures_paper/H3K4me3/clustering_1/01.clustering_final_brain.Rds")

fragments <- "~/snakemake/fragments/H3K4me3/fragments.tsv.gz"
...
png(file = '../Figure2_src/Sox10_heatmap_H3K4me3.png',width = 2048,height = 1024)
p
dev.off()
...
```{r}
brain.H3K27me3 <- readRDS("~/snakemake/figures_paper/H3K27me3/clustering_1/01.clustering_final_brain.Rds")

fragments <- "~/snakemake/fragments/H3K27me3/fragments.tsv.gz"
fragments <- rtracklayer::import(fragments,format='bed')
...
p <- plotHeatmapBW(object = brain.H3K27me3,
            ...
            window = window_bin,
            annotFilter = flt,
            fraction = fraction,clusters_order = c("Astrocytes","mOL","OEC","VLMC"))
...
png(file = '../Figure2_src/Sox10_heatmap_H3K27me3.png',width = 2048,height = 1024)
p
dev.off()
