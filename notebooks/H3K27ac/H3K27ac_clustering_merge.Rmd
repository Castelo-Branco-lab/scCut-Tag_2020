...
brain.markers.ls <- lapply(unique(markers.Sox10$cluster),function(x){
  marker.genes <- markers.Sox10[markers.Sox10$cluster==x & markers.Sox10$p_val_adj < 0.05 & markers.Sox10$avg_logFC > 0,"gene"]
...
names(brain.markers.ls)  <- gsub("-",".",unique(markers.Sox10$cluster))
