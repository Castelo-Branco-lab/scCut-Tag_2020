...
```{r connect_to_loom}
stenRNA <- connect(filename=config$input$Sten_RNA$loom_file,mode='r+')
...
saveRDS(object = sten.RNA,file = "sten_RNA_temp.Rds")
dir.create("results/Sten_RNA/clustering",recursive = TRUE)
...
saveRDS(object = sten.RNA,"results/Sten_RNA/clustering/01.clustering_20000cells.Rds")
```
...
write.csv2(x = markers,file = "results/Sten_RNA/clustering/sten_RNA_markers.csv")
```
