...
```{r connect_to_loom}
stenRNA <- connect(filename=config$RNA_seq$Sten_RNA$loom_file,mode='r+')
...
saveRDS(object = sten.RNA,file = paste0(params$out_prefix,"sten_RNA_temp.Rds"))
```
...
## Save
saveRDS(object = sten.RNA,paste0(params$out_prefix,"01.clustering_20000cells.Rds"))
```
...
write.csv2(x = markers,file = paste0(params$out_prefix,"sten_RNA_markers.csv"))
```
