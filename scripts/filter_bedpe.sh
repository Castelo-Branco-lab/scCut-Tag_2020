...
BED_R2="R2.bed"
META="metadata.txt"
# BEDPE_OUT="Enhancer_predictions_H3K4me3_filter.bedpe" 
...
#bedtools intersect -a $BED_R1 -b $2 -v > ${BED_R1/.bed/_filter.bed}

# Filter promoters by the H3K4me3 peaks
bedtools intersect -a $BED_R2 -b $2    > ${BED_R2/.bed/_filter.bed}

Rscript /data/proj/GCB_MB/CT/git_test/scCut-Tag_2020/scripts/merge_bedpe.R  $BED_R1 4 ${BED_R2/.bed/_filter.bed} 4 $META 4 $3
